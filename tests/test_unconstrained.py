...
class TestLineSearchMinMethods(unittest.TestCase):
    ...
    def test1(self):
        ...
        self.assertEqual(self.gd_minimzer.minimize(f, self.x0, ot, pt, iters), (0, True))
        
        self.newton_minimizer.minimize(f, self.x0, 0.001, 0.001, iters)
    ...
    def test4(self):
        ...
        self.newton_minimizer.minimize(f, self.x0_rosen, 0.001, 0.001, iters)
